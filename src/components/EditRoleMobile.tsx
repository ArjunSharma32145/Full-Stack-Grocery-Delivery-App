...
function EditRoleMobile() {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen p-6 w-full bg-white'>
      <motion.h1  initial={{ opacity: 0,y:-20 }}
        animate={{ opacity: 1 ,y:0}}
        transition={{ duration: 0.6 }}
        className='text-3xl md:text-4xl font-extrabold text-green-700 text-center mt-8'>Select Your Role</motion.h1>
        ...
        >
         ...
         <input type="tel" id="mobile"  className='w-64 md:w-80 px-4 py-3 rounded-xl border border-gray-300 focus:ring-2 focus:ring-green-500 focus:outline-none text-gray-800' placeholder='eg. 5852575342'
